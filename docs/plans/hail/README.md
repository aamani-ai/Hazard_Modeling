...
| **5. Loss & metrics** ✅ | M3 → M4 | **Compound-Poisson MC** → annual AEP/OEP → EAL, VaR, PML, TVaR. *The part the old repo broke — done right, with a Method-0 contrast + known-answer checks.* Metrics illustrative (placeholder λ). | `m4_loss_metrics/01_loss_metrics` | [`phase-5-loss-metrics.md`](phase-5-loss-metrics.md); A24; methodology §8–§10; risk-metrics ref; `basics_spot_on` |
