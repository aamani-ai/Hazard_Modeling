...
| [`plans/`](plans/) | Planning docs / plan-of-record: per-phase plans, decisions logs, assumptions registers, and the active [`hazard_conus_grid`](plans/hazard_conus_grid/) build plan. |
